...
https://github.com/farshid-azady/Python-Primary/issues
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------
> ### ⚠️لطفا اکر در حل پروژه های بالا به مشکل برخوردید.در بالا همین صفحه در کنار دکمه CODE یه دکمه دیگر هست بنام Issues روش کلیک کن :یه دکمه سبز رنگ هست بنام:New issue🟢روش کلیک کن.من اونجا واست یه صفحه مخصوص خودت طراحی کردم اسمش هست:**🔴گزارش باگ**. اون انتخاب کن.من طوری برات طراحیش کردم که مشکلات بصورت بخش بندی باش تا یاد بگبری چطوری به من گزارش بدی.حتی میتونی عکس گزارش خطا را از قسمتی که برایت توضیح دادم آبرای راهنمایی بیشتر واسم آپلود کنی.حالا دیگه با خیال راحت من در کنارت هستم.تا راحتتر بتونی این مسیر به همراه من طی کنی.موفق باشی./فرشید آزادی-مدرس دوره پایتون .
> از این آدرس هم میتونی مستقیم واردش بشی و مشکلات پروژه را با من در میان بگذاری 👇 👇
**❗ گزارش باگ:** برای پروژه های تمرینی شما دانشجویان.  
**✅ آماده استفاده:** بله، فقط کافی‌ست [👈clicke](https://github.com/farshid-azady/Python-Primary/issues) 🖱️ کنید.
